...
**작성 범위:**
- 제품 전체 PRD: 5-15개 Epic 중심, Story는 선택적
- 특정 기능 PRD: 1-3개 Epic과 상세 Story

| ID | Epic/Story | Priority | 연결된 REQ | MoSCoW | 예상 공수 |
|----|-----------|----------|-----------|--------|----------|
| EP-01 | [Epic 제목] | P0 | REQ-F##, REQ-F## | M | X주 |
| EP-02 | ... | P0 | ... | M | X주 |
| US-01 | [Story 제목] | P0 | REQ-F## | M | X일 |
| ... | ... | ... | ... | ... | ... |
...
4. **추적성**: 모든 REQ는 Epic/Story와 연결 필수
